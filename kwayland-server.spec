...
Source0  : https://download.kde.org/stable/plasma/5.19.0/kwayland-server-5.19.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.19.0/kwayland-server-5.19.0.tar.xz.sig
...
%prep
%setup -q -n kwayland-server-5.19.0
cd %{_builddir}/kwayland-server-5.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591740792
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwayland-server-5.19.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwayland-server/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/kwayland-server-5.19.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kwayland-server/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libKWaylandServer.so.5.19.0
